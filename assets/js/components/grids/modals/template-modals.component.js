 ...
 * <template-modals>
 * -----------------------------------------------------------------------------
 * Pile of tiles that show up next to template 
 *
 *
 * @type {Component}
 *
...
parasails.registerComponent('template-modals', {
  //  ╔═╗╦═╗╔═╗╔═╗╔═╗
  //  ╠═╝╠╦╝║ ║╠═╝╚═╗
  //  ╩  ╩╚═╚═╝╩  ╚═╝
  props: [
  ...
  //  ╩ ╩ ╩ ╩ ╩╩═╝
  template: `
    <div  class="templateModals">
        <!-- start new/edit template modal !-->
