parasails.registerPage('update', {
  ...
  beforeMount: function() {
    ...
    this.formData.totalDividends = this.grid.totalDividends;
    this.formData.spendingBalance = this.grid.spendingBalance;
    this.formData.dividendBalance = this.grid.dividendBalance;
